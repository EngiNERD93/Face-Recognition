...
#root = tkinter.Tk()
#canvas = tkinter.Canvas(root, height=600, width=800, bg="#26342")
...
image2 = face_recognition.load_image_file(os.path.abspath("recognize/images/farah1.png"))
image2_face_encoding = face_recognition.face_encodings(image2)[0]

image3 = face_recognition.load_image_file(os.path.abspath("recognize/images/alex1.png"))
image3_face_encoding = face_recognition.face_encodings(image3)[0]

image4 = face_recognition.load_image_file(os.path.abspath("recognize/images/laswell1.png"))
image4_face_encoding = face_recognition.face_encodings(image4)[0]

image5 = face_recognition.load_image_file(os.path.abspath("recognize/images/badguy1.png"))
image5_face_encoding = face_recognition.face_encodings(image5)[0]

image6 = face_recognition.load_image_file(os.path.abspath("recognize/images/me.jpg"))
image6_face_encoding = face_recognition.face_encodings(image6)[0]

image7 = face_recognition.load_image_file(os.path.abspath("recognize/images/Shivraj.jpg"))
image7_face_encoding = face_recognition.face_encodings(image7)[0]

image8 = face_recognition.load_image_file(os.path.abspath("recognize/images/Chinmay.jpg"))
image8_face_encoding = face_recognition.face_encodings(image8)[0]

image9 = face_recognition.load_image_file(os.path.abspath("recognize/images/Ankita.jpg"))
image9_face_encoding = face_recognition.face_encodings(image9)[0]

image10 = face_recognition.load_image_file(os.path.abspath("recognize/images/Saim.jpg"))
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.putText(frame, name, (left + 6, bottom - 6), font, 1, (0, 0, 0), 1)
